...
// export const getPlaylistsByCategoryId = createAsyncThunk(
//     'playlist/getPlaylistsByCategoryId',
//     async (options, thunkAPI) => {
//         try {
//             return await playlistService.getPlaylistsByCategoryId(options)
//         } catch (error) {
//             console.log(error)
//             const message =
...
//             })
//             .addCase(getPlaylistsByCategoryId.rejected, (state, action) => {
//                 state.isLoadingPlaylist = true
//                 state.isErrorPlaylist = false
//                 state.errorMessagePlaylist = action.payload
//             })
