...
// get playlists
export const getPlaylists = createAsyncThunk('me/getPlaylists', async (_, thunkAPI) => {
    try {
        const token = thunkAPI.getState().auth.user.token
        return await meService.getPlaylists(token)
    } catch (error) {
        const message =
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(updatePlaylist.fulfilled, (state, action) => {
                ...
                const index = state.playlists.findIndex((playlist) => {
                    return playlist.id === action.payload.id
                })
                index !== -1 && (state.playlists[index] = action.payload)
            })
            ...
            .addCase(deletePlaylist.fulfilled, (state, action) => {
                ...
                index !== -1 && state.playlists.splice(index, 1)
            })
            ...
            .addCase(updateSong.fulfilled, (state, action) => {
                ...
                index !== -1 && (state.songs[index] = action.payload)
            })
            ...
            .addCase(deleteSong.fulfilled, (state, action) => {
                ...
                index !== -1 && state.songs.splice(index, 1)
            })
