    ...
    return (
        <div className="flex flex-col justify-start items-center gap-4 w-[368px]">
            <div className="flex flex-col justify-center items-center gap-1">
                ...
                <span className="text-xs text-primary font-">Click on the picture to change the thumnail playlist</span>
                <input
                    id="avatarzone-file"
                    type="file"
                    accept="image/*"
            ...
            <div className="flex flex-col justify-start gap-2 w-full h-[98px]">
                <label className="text-xs text-[#666666] font-semibold">Description</label>
                <input
                    value={description}
                    name="description"
                    className="bg-rgba-0-005 border border-[#CCCCCC] outline-none rounded w-full px-4 py-3 focus:border-rgba-0-03"
