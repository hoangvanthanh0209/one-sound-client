...
function Card({ type = 'playlist', data = {} }) {
    return (
        <div
            className="col-span-1 p-4 bg-18 border-none rounded-md overflow-hidden cursor-pointer card hover:bg-28"
            onContextMenu={(e) => {
                e.preventDefault()
                console.log('ok')
            }}
            ...
            <div>
                <div className="relative">
                    ...
                    {type !== 'artist' && (
                        <div className="absolute top-2 left-2">
                            <FaSpotify className="fill-white" />
                        </div>
                    )}
                ...
                <div className="mt-4">
                    ...
                    <div className="w-full h-10 overflow-hidden card-desc mt-2">
                        <h3 className="text-8A text-sm w-full h-full">
